...
<head>
        <title>Hotel Booking | Agra Tour & Travels</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        if(isset($_GET['details']))
        {
             $delt = $_GET['details'];
                    ...
                    $quec = "select * from international where heading='$delt'";
                ...
                <div class="container">
                    <div class="row">        	
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 content-side">
                            ...
                            <div class="detail-slider">
                                <div class="feature-slider">
                                    <div><img src="images/international/<?php echo $val['image1'];?>" class="img-responsive" alt="feature-img" style="height:350px;"/></div>
                                    <div><img src="images/international/<?php echo $val['image2'];?>" alt="feature-img" style="height:350px;"/></div>
                                    <div><img src="images/international/<?php echo $val['image1'];?>" alt="feature-img" style="height:350px;"/></div>
                                    <div><img src="images/international/<?php echo $val['image1'];?>" alt="feature-img" style="height:350px;"/></div>
                                    <div><img src="images/international/<?php echo $val['image2'];?>" alt="feature-img" style="height:350px;"/></div>
                                </div><!-- end feature-slider -->
                            	
                                <div class="feature-slider-nav">
                                    <div><img src="images/international/<?php echo $val['image1'];?>" class="img-responsive" alt="feature-thumb" style="height:80px;"/></div>
                                    <div><img src="images/international/<?php echo $val['image2'];?>" class="img-responsive" alt="feature-thumb" style="height:80px;"/></div>
                                    <div><img src="images/international/<?php echo $val['image1'];?>" class="img-responsive" alt="feature-thumb" style="height:80px;"/></div>
                                    <div><img src="images/international/<?php echo $val['image2'];?>" class="img-responsive" alt="feature-thumb" style="height:80px;"/></div>
                                    <div><img src="images/international/<?php echo $val['image1'];?>" class="img-responsive" alt="feature-thumb" style="height:80px;"/></div>
                            ...
                            <div class="detail-tabs">
                            	<ul class="nav nav-tabs nav-justified">
                                    ...
                                    <li><a href="#package-details" data-toggle="tab">Hotels facilities Detail</a></li>
                                    <li><a href="#itinerary" data-toggle="tab">Map</a></li>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="package-details" class="tab-pane">
                                    	<div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-12 tab-text">
                                        		<h3>Hotels facilities Details</h3>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 side-bar right-side-bar">
                            ...
                            <?php include("include/hotel-booking.php");?>
                            <!-- end side-bar-block -->
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-12">
                                    <div class="side-bar-block main-block ad-block">
                                        <div class="main-img ad-img">
                                            <a href="cab-booking-details.php">
