...
<head>
        <title>Hotels in Agra | Best Place Stay In Agra</title>
        <meta charset="utf-8">
     ...
     <?php include'include/header.php';?>
        ...
        <section class="page-cover" id="cover-hotel-grid-list">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                    	<h1 class="page-title">Hotel in Agra </h1>
                        <ul class="breadcrumb">
                            <li><a href="#">Home</a></li>
                ...
                <div class="container">
                    <div class="row">        	
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 content-side">
                            <div class="row">
                                    <?php
                    $quec = "select * from international";
                                    ...
                                    <div class="grid-block main-block h-grid-block">
                                    	<div class="main-img h-grid-img">
                                        	<a href="hotel-detail-right-sidebar.html">
                                    			<img src="images/international/<?php echo $val['image1'];?>" class="img-responsive" alt="international tour package" style="height:252px;"/>
                                            </a>
                                            <div class="main-mask">
...
<div class="grid-btn pull-left">
                                            	<a href="hotels-booking-details.php?details=<?php echo $val['heading'];?>" class="btn btn-orange btn-block btn-lg">Book Now</a>
</div><!-- end grid-btn -->
<div class="grid-btn pull-right">
                                            	<a href="hotels-booking-details.php?details=<?php echo $val['heading'];?>" class="btn btn-orange btn-block btn-lg">View Details</a>
                                            </div><!-- end grid-btn -->
