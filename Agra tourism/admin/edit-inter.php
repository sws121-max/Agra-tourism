...
$que = "select * from international where id='$edit'";
...
if(isset($_POST['submit']))
{
 ...
 $query = "UPDATE `international` SET `location` = '$location',heading='$heading',price='$price',duration='$duration',overview='$overview',info='$info',iti='$iti',terms='$terms',image1='$img1',image2='$img2',details='$details' WHERE `id` = '$edit';";
   ...
   // exit();
        ...
        if($insert)
        {
            ...
            echo "<script>window.location.href='mng-inter.php'</script>";
        }
