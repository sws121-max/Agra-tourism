        ...
        <?php
            foreach($select as $rows=>$val)
           {
		    ...
		    <tr>
		        ...
		        <td><img src="../images/international/<?php echo  ($val['image1']);?>" alt="" width="100px" height="100px"></td>
		        <td><?php echo  ucwords($val['details']);?></td>
		        <td>
		        <a href="edit-inter.php?edit=<?php echo $val['id'];?> " class="btn btn-success">Edit</a>
		        <a href="mng-inter.php?del=<?php echo $val['id'];?> " class="btn btn-danger">Delete</a></td>
		    </tr>
		    <?php } ?>
		</table>
		<?php }
...
if(isset($_GET['del']))
{
    ...
    if($dmsg)
    {
        ...
        echo "<script>window.location='mng-inter.php';</script>";
    }
