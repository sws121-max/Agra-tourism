...
if(isset($_POST['submit']))
{
    ...
    $query = "insert into 	domestic(heading,location,price,image1,image2,details,duration,overview,iti,info,terms)values('$heading','$location','$price','$img1','$img2','$details','$duration','$overview',' $iti','$info','$terms')";
   ...
   // exit();
        ...
        if($insert)
        {
            ...
            echo "<script>window.location.href='add-domestic.php'</script>";
        }
